...
{og_meta(site, "News | noto Lab", desc, canonical)}<link rel="alternate" type="application/rss+xml" title="noto Lab Feed" href="../feed.xml"><link rel="stylesheet" href="../styles.css"><script src="../script.js" defer></script></head><body>
...
{og_meta(site, title, desc, canonical, item.get("image") or None, "article")}<link rel="alternate" type="application/rss+xml" title="noto Lab Feed" href="../feed.xml"><link rel="stylesheet" href="../styles.css"><script src="../script.js" defer></script></head><body>
