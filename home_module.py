...
{og_meta(site, site["title"], desc, site["url"])}<link rel="alternate" type="application/rss+xml" title="noto Lab Feed" href="feed.xml"><link rel="stylesheet" href="styles.css?v=20260808j"><script src="script.js?v=20260808i" defer></script><script type="application/ld+json">{_json_ld(data)}</script></head><body class="home-page">
...
{og_meta(site, "Contact | noto Lab", desc, canonical)}<link rel="stylesheet" href="styles.css?v=20260808j"><script src="script.js?v=20260808i" defer></script></head><body>
